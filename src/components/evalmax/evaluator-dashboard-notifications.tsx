...
interface EvaluatorNotificationsProps {
...
export default function EvaluatorNotifications({ notifications, deleteNotification, approvals, handleApprovalAction }: EvaluatorNotificationsProps) {
    return (
