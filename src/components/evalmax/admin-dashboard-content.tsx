  ...
  const renderContent = () => {
    switch(activeView) {
        ...
        case 'work-rate-view': {
            ...
            return <WorkRateManagement results={usersForWorkRate} workRateInputs={workRateInputs} selectedDate={selectedDate} holidays={holidays} setHolidays={setHolidays} attendanceTypes={attendanceTypes} setAttendanceTypes={setAttendanceTypes} />;
        }
        case 'shortened-work-details':
            return <WorkRateDetails type="shortenedWork" data={Array.from(userMap.values())} selectedDate={selectedDate} attendanceTypes={attendanceTypes} workRateInputs={workRateInputs}/>;
        case 'daily-attendance-details':
            return <WorkRateDetails type="dailyAttendance" data={Array.from(userMap.values())} selectedDate={selectedDate} attendanceTypes={attendanceTypes} workRateInputs={workRateInputs}/>;
        case 'approvals': {
